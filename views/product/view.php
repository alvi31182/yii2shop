								...
								<?php endif;?>
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<a href="<?=Url::to("/product/{$hit->id}");?>">
														<?=Html::img("@web/images/home/{$hit->img}");?>
													</a>
													<h2>$<?=$hit->price?></h2>
													<a href="<?=Url::to("/product/{$hit->id}");?>"><p><?=$hit->name;?></p>
													<button data-id="<?=$hit->id;?>" data-product="<?=Url::to(['cart/add', 'id' => $hit->id]);?>" type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</button>
												</div>
											</div>
										</div>
									</div>
